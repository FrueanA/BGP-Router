...
- **Longest prefix match**: Required canonical conversion of dotted IP and mask values into integers and bitwise comparison logic.  
- **Aggregation/disaggregation**: Managing adjacent network detection while ensuring routes share identical attributes.  
- **Propagation logic**: Correctly enforcing which neighbors receive updates/withdraws based on BGP economics.  
- **Routing table rebuilds** after withdrawals to avoid stale or partially aggregated state.  
